      ...
      <div className="relative z-10 container mx-auto px-6 grid lg:grid-cols-12 gap-12 items-center">
        <div className="lg:col-span-8 text-white space-y-8 animate-in fade-in slide-in-from-left duration-1000">
          ...
          <div className="flex flex-col gap-4">
            <span className="text-2xl md:text-3xl font-bold text-slate-300">Bairro Barragem - Rio do Sul</span>
          ...
          <div className="flex flex-col sm:flex-row gap-6 pt-10">
            <a
              href="#simulacao"
              className="px-10 py-5 bg-emerald-600 hover:bg-emerald-500 text-white rounded-2xl font-black text-lg transition-all shadow-2xl shadow-emerald-500/20 flex items-center justify-center gap-3 active:scale-95 group uppercase tracking-widest text-[13px]"
            >
            ...
            <a
              href="#galeria"
              className="px-10 py-5 bg-white/5 hover:bg-white/10 text-white rounded-2xl font-black text-lg transition-all backdrop-blur-md flex items-center justify-center border border-white/10 active:scale-95 uppercase tracking-widest text-[13px]"
            >
              Ver Fotos Reais
            </a>
          </div>
